...
<div class="row">
  <div class="col-md-12">
    <h1 class="display-4">Bienvenido a Inventio Lite</h1>
  </div>
</div>
...
<div class="row">
  ...
  <div class="col-6 col-lg-3 mb-4">
    <div class="card h-100">
      <div class="card-body p-3 d-flex align-items-center">
        <div class="bg-info text-white p-3 me-3 rounded-circle">
          <svg class="icon icon-xl">
  ...
  <div class="col-6 col-lg-3 mb-4">
    <div class="card h-100">
      <div class="card-body p-3 d-flex align-items-center">
        <div class="bg-danger text-white p-3 me-3 rounded-circle">
          <svg class="icon icon-xl">
